...
def main():
    ...
    subprocess.run([git_exe, "commit", "-m", "fix(prompt): add strict prohibition and regex sanitization to prevent AI hallucination of episode numbers"], capture_output=True)
